...
```{R}
data_labelled <- readRDS("~/altcells/singlecellseq/vitalia_scs_aro/processed_data/data_labelled.RDS")
```
...
saveRDS(all.markers,
file = "~/altcells/singlecellseq/vitalia_scs_aro/processed_data/all_markers.RDS")
```

```{R}
all_markers <- readRDS("~/altcells/singlecellseq/vitalia_scs_aro/processed_data/all_markers.RDS")
```
