...
### PTX vs. Control
```{R}
genes <- c("NOTCH1", "ICAM1", "TNF", "MGP", "HSPA12A", "TRP53", "DCN") |> str_to_sentence()
directions <- c("Downregulated", "Downregulated", "Downregulated",
...
# Plot
ggplot(df_expr, aes(x = gene, y = mean_expression, fill = direction)) +
...
ggsave(file.path(fig_folder, "deg_barplot_ptx_control_calcific.png"),
...
genes <- c("HSPA1A", "IL1B", "TNF", "MGP", "Notch1",
           "DCN") |> str_to_sentence()
directions <- c("Downregulated", "Upregulated", "Upregulated",
                "Downregulated", "Upregulated",
                "Downregulated")
which_trts <- c("control", "PDtreatment")
...
ggsave(file.path(fig_folder, "deg_barplot_ptxdex_control_calcific.png"),
       units = "in", width = 8, height = 3)
